  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
        case 'Beschreibung':
            return (
              <>
                <Text style={styles.detailTitle}>Typdefinition: </Text>
                <Text style={styles.detail}>{roasteryData.typeDefinition}</Text>
                <Text style={styles.detailTitle}>Typerklärung: </Text>
                <Text style={styles.detail}>{roasteryData.typeExplanation}</Text>
                <Text style={styles.detailTitle}>Koffeinmenge: </Text>
                <Text style={styles.detail}>{roasteryData.caffeineAmount}</Text>
                <Text style={styles.detailTitle}>Bohnengröße: </Text>
                <Text style={styles.detail}>{roasteryData.beanFormSize}</Text>
                <Text style={styles.detailTitle}>Durchschnittspreis: </Text>
                <Text style={styles.detail}>{roasteryData.avgPrice}</Text>
              </>
            );
      case 'Bewertungen':
